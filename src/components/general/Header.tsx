...
const Header = () => {
  return (
    <div>
      <MobileHeader />
      <header className="hidden sm:flex items-center justify-between sm:py-1 md:py-2 lg:py-3 xl:py-3 px-0 container linkText py-2">
        ...
        <div className="w-2/3 sm:w-2/3 md:w-1/2  flex items-center justify-between">
          <Link
            className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl mx-0.5 sm:mx-1 lg:mx-2 xl:mx-4"
            to="/movies"
          >
            Movies
          </Link>
